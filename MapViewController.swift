...
extension MapViewController: MKMapViewDelegate {
    func mapView(
      ...
      // Determine wheather the annotation is really a Location object, if not return nil
      guard annotation is Location else {
        return nil
      }
        
      // Ask the map view to re-use an annotation view object, if cannot find a recyclable annotation view, then create a new one.
