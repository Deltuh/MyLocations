...
class LocationsViewController: UITableViewController {
    ...
    // Methods gets called once for each section in the table view, create a lable for the section name,
    // a 1-pixel high view that acts as a separator line, and a container view to hold these two subviews.
    override func tableView(
      _ tableView: UITableView,
